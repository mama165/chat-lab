	...
	analyses := []Analysis{
		{
			...
			Scores:    map[domain.Metric]float64{domain.MetricToxicity: 0.1},
		...
		},
		{
			...
			Scores:    map[domain.Metric]float64{domain.MetricToxicity: 0.2},
		...
		},
		{
			...
			Scores:    map[domain.Metric]float64{domain.MetricToxicity: 0.3},
