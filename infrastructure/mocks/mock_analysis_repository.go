...
// Source: analysis_repository.go
//
// Generated by this command:
//
//	mockgen -source=analysis_repository.go -destination=../mocks/mock_analysis_repository.go -package=mocks
//
...
func (m *MockIAnalysisRepository) Store(analysis storage.Analysis) error {
	m.ctrl.T.Helper()
...
func (m *MockIAnalysisRepository) StoreBatch(analyses []storage.Analysis) error {
	m.ctrl.T.Helper()
