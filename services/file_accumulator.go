...
func (a *FileAccumulator) ProcessResponse(ctx context.Context, resp domain.FileDownloaderResponse) error {
	...
	case resp.FileMetadata != nil:
		...
		a.buffers[fileID] = &domain.FileBuffer{File: f, Path: path, MimeType: resp.FileMetadata.MimeType}
...
func (a *FileAccumulator) finalize(fileID domain.FileID, expectedSha string) (string, string, error) {
	...
	return fileBuffer.Path, fileBuffer.MimeType, nil
}
